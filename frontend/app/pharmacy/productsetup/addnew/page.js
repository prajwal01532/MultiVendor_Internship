...
import { fetchStores, fetchCategories, fetchSubCategories, createProduct, fetchUnits, fetchProductById, updateProduct } from '@/services/pharmacyProductService';
      ...
      if (response.success) {
        ...
        if (isEditMode) {
          // In edit mode, redirect to the list page
              router.push('/pharmacy/productsetup/list');
        } else {
