...
import { fetchProducts, deleteProduct, updateProduct } from '@/services/pharmacyProductService';
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Link 
          href="/pharmacy/productsetup/addnew"
              ...
              {filteredProducts.map((product) => (
                <tr key={product._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <button
                      onClick={() => router.push(`/food/productsetup/addnew?id=${product._id}`)}
