...
const Page = () => {
    ...
    const fetchNotifications = async () => {
        try {
            const response = await api.get('/pharmacynotifications/notifications');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response;
            if (isEditing) {
                response = await api.patch(`/pharmacynotifications/notifications/${editingId}`, submitData);
            } else {
                response = await api.post('/pharmacynotifications/notifications', submitData);
            }
    ...
    const handleStatusChange = async (id) => {
        try {
            const response = await api.patch(`/pharmacynotifications/notifications/${id}/toggle-status`);
            if (response.data.success) {
                fetchNotifications();
            }
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await api.delete(`/pharmacynotifications/notifications/${id}`);
            if (response.data.success) {
