...
const Page = () => {
    ...
    const fetchNotifications = async () => {
        try {
            const response = await api.get('/foodnotifications/notifications');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response;
            if (isEditing) {
                response = await api.patch(`/foodnotifications/notifications/${editingId}`, submitData);
            } else {
                response = await api.post('/foodnotifications/notifications', submitData);
            }
    ...
    const handleStatusChange = async (id) => {
        try {
            const response = await api.patch(`/foodnotifications/notifications/${id}/toggle-status`);
            if (response.data.success) {
                fetchNotifications();
            }
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await api.delete(`/foodnotifications/notifications/${id}`);
            if (response.data.success) {
