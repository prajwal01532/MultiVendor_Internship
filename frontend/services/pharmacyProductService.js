...
export const fetchStores = async () => {
  try {
    const response = await api.get('/pharmacystores', {
      params: {
        status: 'active',
        sortField: 'name',
        sortOrder: 'asc'
...
export const fetchCategories = async () => {
  try {
    ...
    const response = await api.get('/pharmacyproducts/categories');
...
export const createCategory = async (categoryData) => {
  try {
    ...
    // Make the API call
    const response = await api.post('/pharmacyproducts/categories', formData, {
      headers: {
...
export const fetchSubCategories = async (categoryId = null) => {
  try {
    ...
    const url = categoryId 
      ? `/pharmacyproducts/subcategories?category=${categoryId}` 
      : '/pharmacyproducts/subcategories';
...
export const createSubCategory = async (subCategoryData) => {
  try {
    ...
    const response = await api.post('/pharmacyproducts/subcategories', requestData);
...
export const fetchUnits = async () => {
  try {
    const response = await api.get('/pharmacyproducts/units');
...
export const createProduct = async (productData) => {
  try {
    ...
    const response = await api.post('/pharmacyproducts', formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
export const updateCategory = async (id, categoryData) => {
  try {
    ...
    const response = await api.put(`/pharmacyproducts/categories/${id}`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
export const deleteCategory = async (id) => {
  try {
    const response = await api.delete(`/pharmacyproducts/categories/${id}`);
...
export const updateSubCategory = async (id, subCategoryData) => {
  try {
    ...
    const response = await api.put(`/pharmacyproducts/subcategories/${id}`, requestData, {
      headers: {
...
export const deleteSubCategory = async (id) => {
  try {
    const response = await api.delete(`/pharmacyproducts/subcategories/${id}`);
...
export const fetchProducts = async (filters = {}) => {
  try {
    ...
    const response = await api.get(`/pharmacyproducts?${queryParams.toString()}`);
...
export const deleteProduct = async (id) => {
  try {
    const response = await api.delete(`/pharmacyproducts/${id}`);
...
export const updateProduct = async (id, productData) => {
  try {
    ...
    const response = await api.put(`/pharmacyproducts/${id}`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
export const fetchProductById = async (id) => {
  try {
    const response = await api.get(`/pharmacyproducts/${id}`);
