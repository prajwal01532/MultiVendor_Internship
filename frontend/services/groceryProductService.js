...
export const fetchCategories = async () => {
  try {
    ...
    const response = await api.get('/groceryproducts/categories');
...
export const createCategory = async (categoryData) => {
  try {
    ...
    // Make the API call
    const response = await api.post('/groceryproducts/categories', formData, {
      headers: {
...
export const fetchSubCategories = async (categoryId = null) => {
  try {
    ...
    const url = categoryId 
      ? `/groceryproducts/subcategories?category=${categoryId}` 
      : '/groceryproducts/subcategories';
...
export const createSubCategory = async (subCategoryData) => {
  try {
    ...
    const response = await api.post('/groceryproducts/subcategories', requestData);
...
export const fetchUnits = async () => {
  try {
    const response = await api.get('/groceryproducts/units');
...
export const createProduct = async (productData) => {
  try {
    ...
    const response = await api.post('/groceryproducts', formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
export const updateCategory = async (id, categoryData) => {
  try {
    ...
    const response = await api.put(`/groceryproducts/categories/${id}`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
export const deleteCategory = async (id) => {
  try {
    const response = await api.delete(`/groceryproducts/categories/${id}`);
...
export const updateSubCategory = async (id, subCategoryData) => {
  try {
    ...
    const response = await api.put(`/groceryproducts/subcategories/${id}`, requestData, {
      headers: {
...
export const deleteSubCategory = async (id) => {
  try {
    const response = await api.delete(`/groceryproducts/subcategories/${id}`);
...
export const fetchProducts = async (filters = {}) => {
  try {
    ...
    const response = await api.get(`/groceryproducts?${queryParams.toString()}`);
...
export const deleteProduct = async (id) => {
  try {
    const response = await api.delete(`/groceryproducts/${id}`);
...
export const updateProduct = async (id, productData) => {
  try {
    ...
    const response = await api.put(`/groceryproducts/${id}`, formData, {
      headers: {
        'Content-Type': 'multipart/form-data'
      }
    });
...
export const fetchProductById = async (id) => {
  try {
    const response = await api.get(`/groceryproducts/${id}`);
