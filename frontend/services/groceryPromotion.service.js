...
class PromotionServiceClass {
    ...
    async createCoupon(couponData) {
        try {
            ...
            const response = await axios.post(`${API_URL}/api/grocerypromotions/coupons`, transformedData, config);
    ...
    async listCoupons() {
        try {
            ...
            const response = await axios.get(`${API_URL}/api/grocerypromotions/coupons`, config);
    ...
    async updateCouponStatus(couponId, status) {
        try {
            ...
            const response = await axios.patch(`${API_URL}/api/grocerypromotions/coupons/${couponId}/status`, { status }, config);
    ...
    async deleteCoupon(couponId) {
        try {
            ...
            const response = await axios.delete(`${API_URL}/api/grocerypromotions/coupons/${couponId}`, config);
    ...
    async createCashback(cashbackData) {
        try {
            ...
            const response = await axios.post(`${API_URL}/api/grocery/cashback`, {
                ...cashbackData,
    ...
    async listCashbacks() {
        try {
            const response = await axios.get(`${API_URL}/api/grocery/cashbacks`, {
    ...
    async updateCashbackStatus(cashbackId, status) {
        try {
            const response = await axios.patch(`${API_URL}/api/grocery/cashback/${cashbackId}/status`, { status }, {
                withCredentials: true
            });
            return response.data;
        } catch (error) {
    ...
    async updateCashback(cashbackId, cashbackData) {
        try {
            const response = await axios.put(`${API_URL}/api/grocery/cashback/${cashbackId}`, {
                ...cashbackData,
                title: {
    ...
    async validateCoupon(couponData) {
        try {
            const response = await axios.post(`${API_URL}/api/grocerypromotion/coupons/validate`, couponData, {
                withCredentials: true
            });
            return response.data;
        } catch (error) {
