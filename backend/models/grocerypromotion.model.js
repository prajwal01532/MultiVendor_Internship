...
const bannerSchema = new Schema({
    ...
    zone: { type: Schema.Types.ObjectId, ref: 'GroceryZone' }
}, { timestamps: true });
...
const cashbackSchema = new Schema({
    title: { type: String, required: true },
    customerId: { type: Schema.Types.ObjectId, ref: 'GroceryCustomer' },
...
const notificationSchema = new Schema({
    ...
    sender: { type: Schema.Types.ObjectId, ref: 'GroceryUser' },
...
const Campaign = mongoose.model('GroceryCampaign', campaignSchema);
const Cashback = mongoose.model('GroceryCashback', cashbackSchema);
const Coupon = mongoose.model('GroceryCoupon', couponSchema);
const Notification = mongoose.model('GroceryNotification', notificationSchema);
